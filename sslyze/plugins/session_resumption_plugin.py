...
class SessionResumptionPlugin(Plugin):
    ...
    def _test_session_resumption_rate(
        self, server_info: ServerConnectivityInfo, ssl_version_to_use: OpenSslVersionEnum, resumption_attempts_nb: int
    ) -> Tuple[int, List[str]]:
    ...
    def _resume_with_session_id(
        self, server_info: ServerConnectivityInfo, ssl_version_to_use: OpenSslVersionEnum
    ) -> bool:
